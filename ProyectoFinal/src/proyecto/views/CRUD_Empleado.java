...
public class CRUD_Empleado {
    ...
    Label l= new Label("CRUD Empleado");
    //tabla de clientes
	...
	v.setSpacing(20.0);
        ...
        Label l10=new Label("Cargo: ");
                labels.getChildren().addAll(l1,l2,l3,l4,l5,l6,l7,l8,l9,l10);
        ...
        areas.getChildren().addAll(nombre,apellido,cedula,pasaporte,correo,direccion,empresa,telefono,estado,cargo);
